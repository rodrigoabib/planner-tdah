    ...
    <div style={PLACEHOLDER_STYLE}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 14, color: '#897FC0', lineHeight: 1.6, marginBottom: 12 }}>
          Conteúdo aprovado em FOUNDATION-3 (KAN-9), arquivo <code style={{ color: '#C4B5FD' }}>foundation/legal/politica-privacidade.md</code>.
        </p>
        <p style={{ fontSize: 14, color: '#897FC0', lineHeight: 1.6 }}>
          Será renderizado nesta rota após preenchimento dos placeholders (DPO, e-mail de privacidade, endereço) e ligação real.
        </p>
      </div>
    </div>
  )
